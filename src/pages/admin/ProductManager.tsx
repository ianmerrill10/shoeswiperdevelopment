              ...
              <div className="flex gap-4 items-start">
                <div className="flex-1">
                  ...
                  <input
                    ...
                    required
                  />
                  <p className="text-xs text-zinc-500 mt-1">Must be a direct link to an image (JPG/PNG).</p>
                </div>
                {editingProduct.image_url && (
                  <div className="w-16 h-16 bg-zinc-800 rounded-lg overflow-hidden border border-zinc-700 flex-shrink-0 mt-6">
                    <img
