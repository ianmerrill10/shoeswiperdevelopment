...
// ============================================
const APPLE_AFFILIATE_TOKEN = '1000lJFj';
...
// Verified sneaker placeholder images (using placeholder service with consistent sneaker images)
// These use a reliable CDN with actual sneaker photos
const SNEAKER_IMAGES = [
  ...
  'https://static.nike.com/a/images/t_PDP_1280_v1/f_auto,q_auto:eco/a0a300da-2e16-4483-ba64-9815cf0598ac/air-max-90-shoes-kRsBnD.png',
  'https://static.nike.com/a/images/t_PDP_1280_v1/f_auto,q_auto:eco/af53d53d-561f-450a-a483-70a7ceee380f/air-max-270-shoes-2V5C4p.png',
  'https://static.nike.com/a/images/t_PDP_1280_v1/f_auto,q_auto:eco/d3eb254d-0901-4158-956a-4610180545e5/air-max-plus-shoes-Sj8JfX.png',
  'https://static.nike.com/a/images/t_PDP_1280_v1/f_auto,q_auto:eco/80e68e58-10f4-4d7d-b4b5-8e66fd1a1295/blazer-mid-77-vintage-shoes-CBCZvh.png',
  'https://static.nike.com/a/images/t_PDP_1280_v1/f_auto,q_auto:eco/e6da41fa-1be4-4ce5-b89c-22be4f1f02d4/air-jordan-1-retro-high-og-shoes-Dz1lkC.png',
  'https://static.nike.com/a/images/t_PDP_1280_v1/f_auto,q_auto:eco/64797ee6-9947-4e02-bfd4-dd5e2a0e5d8a/air-jordan-4-retro-shoes-GVMFxl.png',
  'https://brand.assets.adidas.com/image/upload/f_auto,q_auto,fl_lossy/if_w_gt_800,w_800/enUS/Images/adidas-samba-og-shoes-white-IF1811_01_standard-d7b61f2f0b5d2d5f0e7fdb50916ac696.jpg',
  'https://brand.assets.adidas.com/image/upload/f_auto,q_auto,fl_lossy/if_w_gt_800,w_800/enUS/Images/superstar-shoes-white-EG4958_01_standard-bfdbb6bda6ff35a8e66fdd8f3e5fecc8.jpg',
  'https://nb.scene7.com/is/image/NB/bb550wt1_nb_02_i?$pdpflexf2$&qlt=80&fmt=webp&wid=880&hei=880',
  'https://nb.scene7.com/is/image/NB/m574gm_nb_02_i?$pdpflexf2$&qlt=80&fmt=webp&wid=880&hei=880',
  'https://www.converse.com/dw/image/v2/BCZC_PRD/on/demandware.static/-/Sites-cnv-master-catalog/default/dw0eb5dada/images/a_107/M9160_A_107X1.jpg',
  'https://images.vans.com/is/image/Vans/VN000EE3BLK-HERO?$PDP-FULL-IMAGE$',
  'https://images.puma.com/image/upload/f_auto,q_auto,b_rgb:fafafa,w_750,h_750/global/374915/01/sv01/fnd/PNA/fmt/png',
];

// Get sneaker image based on shoe ID for variety
const getImageForBrand = (_brand: string, id: number = 0): string => {
  return SNEAKER_IMAGES[id % SNEAKER_IMAGES.length];
};
...
const createShoe = (
  ...
  image_url: getImageForBrand(brand, id),
  gender,
