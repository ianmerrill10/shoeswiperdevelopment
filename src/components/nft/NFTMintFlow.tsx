            ...
            return (
              ...
              >
                <div className="relative flex flex-col items-center gap-1">
                  <div
                    className={`flex h-8 w-8 items-center justify-center rounded-full border text-xs font-bold transition ${isCompleted
              ...
              {closet.map((sneaker) => {
                ...
                return (
                  <button
                    ...
                    className={`group flex flex-col rounded-2xl border p-2.5 text-left transition ${isSelected
              ...
              {rarityOptions.map((option) => {
                ...
                return (
                  <button
                    ...
                    className={`relative flex flex-col rounded-2xl border p-[1px] text-left transition ${isSelected
